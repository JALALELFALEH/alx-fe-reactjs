...
function HomePage() {
    ...
    // Recipe Card Component - UPDATED WITH LINK
    ...
    return (
        ...
        <div className="p-5">
            ...
            <Link 
                to={`/recipe/${recipe.id}`}
                className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-opacity-50"
            >
                View Recipe
            </Link>
